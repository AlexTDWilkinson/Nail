...
#
# Usage:
#   ./scripts/test_doc_examples.sh              # every example
#   ./scripts/test_doc_examples.sh array_       # only examples whose name starts with array_
#   ./scripts/test_doc_examples.sh array_chunk hashmap_new   # named examples
#
