...
; if should_print { std_lib::print::print(std_lib::string::concat(vec! ["  Health: ".to_string(), std_lib::string::from(new_health.clone()), ", Gold: ".to_string(), std_lib::string::from(new_gold.clone())])) } else {  };     return updated_player }).await;
    std_lib::print::print("\n========================================".to_string());
