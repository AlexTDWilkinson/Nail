...
async fn main() {
    ...
    println!("{:#?}", std_lib::string::concat(vec! ["Sum 1-10: ".string_from(), string_from(sum.clone())]));
    println!("{:#?}", std_lib::string::concat(vec! ["Product 1-5: ".string_from(), string_from(product.clone())]));
    ...
    println!("{:#?}", std_lib::string::concat(vec! ["Sum of squares 1-5: ".string_from(), string_from(sum_of_squares.clone())]));
    println!("{:#?}", "Done! No loops were used.".string_from());
}
