...
async fn main() {
    ...
    let health_str: String = std_lib::string::from(player_health.clone());
    let level_str: String = std_lib::string::from(player_level.clone());
    let gold_str: String = std_lib::string::from(player_gold.clone());
    let count_str: String = std_lib::string::from(item_count.clone());
