...
pub(super) fn register(m: &mut HashMap<&'static str, StdlibFunction>) {
    simple_fns! { m, Format:
        "format_decimals" => "std_lib::format::decimals", (value: f, places: i) -> (s!e),
            ...
            "price:s = danger(format_decimals(3.5, 2));";
        ...
        "format_thousands_float" => "std_lib::format::thousands_float", (value: f, places: i) -> (s!e),
            ...
            "total:s = danger(format_thousands_float(1234.5, 2));";
        ...
        "format_percent" => "std_lib::format::percent", (fraction: f, places: i) -> (s!e),
            ...
            "share:s = danger(format_percent(0.125, 1));";
