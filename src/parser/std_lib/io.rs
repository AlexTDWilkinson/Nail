...
pub fn read_line_prompt(prompt: String) -> Result<String, String> {
...
pub fn read_int_prompt(prompt: String) -> Result<i64, String> {
    print_no_newline(prompt);
    read_int()
}
...
pub fn read_float_prompt(prompt: String) -> Result<f64, String> {
    print_no_newline(prompt);
    read_float()
}
