...
A clean run currently reports 149/149 lexer/parser, 149/149 type checker and
134/134 transpiler, with zero failures. `cargo test --lib` reports 1103 passing,
and `./test_e2e.sh` reports 357 programs passing.
