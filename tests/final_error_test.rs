...
async fn main() {
    ...
    async fn main() -> () {
        ...
        println!("{}", std_lib::string::concat(vec! ["10 / 2 = ".to_string(), std_lib::convert::to_string(result1)]));
        ...
        println!("{}", std_lib::string::concat(vec! ["Result: ".to_string(), std_lib::convert::to_string(result2)]));
        ...
        println!("{}", std_lib::string::concat(vec! ["Final result: ".to_string(), std_lib::convert::to_string(final_result)]));
    }
}
