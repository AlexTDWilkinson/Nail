...
fn test_integer_arithmetic() {
    let test_cases = vec!["f test():i { r 1 + 2; }", "f test():i { r 5 - 3; }", "f test():i { r 2 * 4; }", "f test():i { r 8 / 2; }", "f test():i { r 7 % 3; }"];
...
fn test_comparison_operators_current_behavior() {
    ...
    let test_cases = vec![
        ("f test():i { r 5 == 5; }", "equality comparison"),
        ("f test():i { r 5 != 3; }", "inequality comparison"),
        ("f test():i { r 5 < 10; }", "less than comparison"),
        ("f test():i { r 10 > 5; }", "greater than comparison"),
        ("f test():i { r 5 <= 5; }", "less than or equal comparison"),
        ("f test():i { r 5 >= 5; }", "greater than or equal comparison"),
    ];
...
fn test_comparison_operators_expected_behavior() {
    ...
    let test_cases = vec![
        ("f test():b { r 5 == 5; }", "equality comparison"),
        ("f test():b { r 5 != 3; }", "inequality comparison"),
        ("f test():b { r 5 < 10; }", "less than comparison"),
        ("f test():b { r 10 > 5; }", "greater than comparison"),
        ("f test():b { r 5 <= 5; }", "less than or equal comparison"),
        ("f test():b { r 5 >= 5; }", "greater than or equal comparison"),
    ];
...
fn test_boolean_type_declaration() {
    ...
    let test_cases = vec![
        "f test():b { r true; }", // If boolean literals work
...
fn test_type_mismatches() {
    ...
    let error_cases =
        vec![("f test():i { r `hello`; }", "string return in int function"), ("f test():s { r 42; }", "int return in string function"), ("f add(x:i, y:s):i { r x + y; }", "adding int and string")];
...
fn test_nested_expressions() {
    let test_cases = vec!["f test():i { r (1 + 2) * 3; }", "f test():i { r 1 + 2 * 3; }", "f test():i { r (x + y) - (a * b); }"];
...
fn test_edge_cases() {
    let test_cases = vec![
        "f test():i { r 0; }",  // Zero
        "f test():i { r -1; }", // Negative (if supported)
        "f test():s { r ``; }", // Empty string
    ];
...
fn test_modulo_operation() {
    ...
    let test_cases = vec![
        "f test():i { r 5 % 2; }", // Basic modulo
        "f test():i { r n % 2; }", // Modulo with variable (might fail without parameter)
    ];
